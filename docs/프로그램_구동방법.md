...
> **참고**: 샘플 수가 100개 미만인 소규모 데이터셋에서는 `--min-effective-n` 옵션을
> 낮춰야 합니다 (기본값: 100).
...
│   ├── final_descriptors.txt      # 최종 74개 descriptor 목록
...
### 7.3 Step 2: Track 2 - ML 모델 학습

Track 1에서 생성된 클러스터 정보를 활용하여 ML 모델을 학습합니다.
...
│   ├── outputs/
│   │   ├── final_cluster_info.json    # 162개 클러스터 정보
│   │   ├── final_descriptors.txt      # 74개 최종 descriptor
...
└── track2_output/                     # Track 2 결과
    ├── best_model.json                # LightGBM, 5D, R²=0.4993
...
|------|------|-------------|-----------|-------------|
| 1 | **LightGBM** | **5** | 0.0773 | **0.4993** |
| 2 | XGBoost | 40 | -0.1097 | 0.4230 |
| 3 | ExtraTrees | 5 | -0.0199 | 0.4202 |
| 4 | RandomForest | 30 | 0.0594 | 0.4117 |
| 5 | RandomForest | 10 | 0.1196 | 0.4111 |
